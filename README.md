...
Сейчас перевод идёт по модулям. Часть файлов ещё является черновыми заглушками, поэтому перед публикацией конкретного раздела нужно проверить:

- нет ли строки `Перевод в процессе`;
- убран ли комментарий `Autogenerated Russian placeholder`;
- переведены ли заголовки и пояснительный текст;
- сохранены ли команды, пути, имена файлов и ссылки на изображения;
- добавлены ли цели, вопросы и практические задания, если раздел учебный.
